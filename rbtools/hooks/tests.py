...
class CommonTest(RBTestBase):
    ...
    def test_ticket_refs(self):
        ...
        self.assertEqual(['10', '11', '2'],
                         find_ticket_refs('see issue: 10,11,2'))
        self.assertEqual(['1', '2', '3', '4', '5'],
                         find_ticket_refs('fixes 1, 2, 3. '
                                          'Addresses 3, 4, 5.'))
        self.assertEqual(['1', 'app-2'],
                         find_ticket_refs('fixes 1, app-2',
                                          prefixes=['', 'app-']))
    ...
    def test_linkify_refs(self):
        ...
        self.assertEqual('fixes [app-10](a/app-10), [app-11](a/app-11)',
                         linkify_ticket_refs('fixes app-10, app-11',
                                             url, prefixes=['app-']))
